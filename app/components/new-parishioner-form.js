...
export default Ember.Component.extend({
  ...
  setDefaultParishioner: function() {
    this.set('parishioner', { name: faker.fake('{{name.lastName}} {{name.firstName}}'), city: faker.address.city(), street: faker.address.streetName(), streetNumber: faker.random.number({ min: 1, max: 100 }) });
  },
});
